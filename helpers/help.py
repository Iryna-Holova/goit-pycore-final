...
def get_help(_) -> str:
    ...
    - {Fore.WHITE}{Style.BRIGHT}change-note{Style.RESET_ALL}{Fore.LIGHTGREEN_EX}: Opens a submenu with commands to change the note: 
        - {Fore.WHITE}{Style.BRIGHT}add-text{Style.RESET_ALL}{Fore.LIGHTGREEN_EX}: Adds text to the note.
        - {Fore.WHITE}{Style.BRIGHT}edit-text{Style.RESET_ALL}{Fore.LIGHTGREEN_EX}: Edits the text of the note.
        - {Fore.WHITE}{Style.BRIGHT}remove-text{Style.RESET_ALL}{Fore.LIGHTGREEN_EX}: Removes text from the note.
        ...
        - {Fore.WHITE}{Style.BRIGHT}edit-reminder{Style.RESET_ALL}{Fore.LIGHTGREEN_EX}:  Edits a reminder of the note.
        - {Fore.WHITE}{Style.BRIGHT}remove-reminder{Style.RESET_ALL}{Fore.LIGHTGREEN_EX}:  Removes reminder from the note.
    ...
    - {Fore.WHITE}{Style.BRIGHT}search-notes{Style.RESET_ALL}{Fore.LIGHTGREEN_EX}: Allows you to search for notes by title or a tag.
